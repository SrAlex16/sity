...
- No imites explícitamente el estilo de ningún referente de ficción concreto.
...
LONGITUD:
{verbosity_rule}
Aunque la verbosidad sea baja, cierra la respuesta correctamente. Nunca dejes frases a medias.
